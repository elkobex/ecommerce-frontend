...
@Component({
  ...
  template: `
    <p
      class="mx-auto mt-10 mb-5 max-w-[1400px] px-4 text-xl md:text-2xl font-bold text-slate-900 text-center"
    >
      RECOMIENDA
    </p>
    ...
    @if (isLoading) {
      <section
        class="mx-auto grid max-w-[1400px] gap-6 px-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
      >
      ...
      >
        @for (product of PRODUCTS; track product.id) {
          <div class="flex flex-col">
            <div
              class="group relative mb-2 w-full max-w-xs overflow-hidden rounded-md bg-white md:hover:shadow transform transition duration-300 ease-in-out"
            >
              ...
              <a [routerLink]="['/detail', product.identifier]">
                <div class="w-auto h-auto relative z-10">
                  <img
                    class="object-cover"
                    src="data:image/jpeg;base64,"
                  />
                  <img
                    class="absolute inset-0 z-20 rounded-sm pb-1 object-cover"
                    src="{{ serverUrl }}/{{ product.imageUrl }}"
                  />
                </div>
              </a>
